...
def _view(monkeypatch) -> tuple[DesktopEphysPanelView, dict[str, FakePlot], list[Any]]:
    monkeypatch.setattr(
        "ephys_alignment_gui.desktop_ephys_panel_view.pg.ImageItem",
        FakeImageItem,
    )
    monkeypatch.setattr(
        "ephys_alignment_gui.desktop_ephys_panel_view.pg.ScatterPlotItem",
        FakePlotItem,
    )
    monkeypatch.setattr(
        "ephys_alignment_gui.desktop_ephys_panel_view.pg.PlotCurveItem",
        FakePlotItem,
    )
    monkeypatch.setattr(
        "ephys_alignment_gui.desktop_ephys_panel_view.pg.InfiniteLine",
        FakeInfiniteLine,
    )
    monkeypatch.setattr(
        "ephys_alignment_gui.desktop_ephys_panel_view.ColorBar",
        FakeColorBar,
    )
    monkeypatch.setattr(
        "ephys_alignment_gui.desktop_ephys_panel_view.QtGui.QTransform",
        FakeTransform,
    )
    plots = {
        "image": FakePlot(),
